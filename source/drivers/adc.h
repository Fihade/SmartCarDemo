...
/********************************************************************/
#define ADC_n           0               // 0, 1
#define ADC_PTR         ADC0_BASE_PTR   // ADC0_BASE_PTR, ADC1_BASE_PTR
//#define ADC0_CHANNEL     23              // 0-23
#define ADC_AB          0               // 0:A, 1:B
#define ADC_MODE        0x01            // 0:8-bit, 1:12-bit, 2:10-bit, 3:16-bit
...
void ADC_Init(void);
uint16 adc_get(void);
uint16 adc_get_channel(int channel);
//============================================================================
//函数名称：adc_once
//函数返回：16位无符号的AD值
//参数说明：MoudelNumber：模块号
